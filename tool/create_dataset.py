...
def createDataset(outputPath, imagePathList, labelList, lexiconList=None, checkValid=True):
    ...
    env = lmdb.open(outputPath, map_size=100000000)
    cache = {}
    cnt = 1
...
# python create_dataset.py --out ../train_lmdb --folder ../data_set/train_set_mobiles --file ../data_set/train_set_mobiles.txt
# python create_dataset.py --out ../val_lmdb --folder ../data_set/val_set_mobiles --file ../data_set/val_set_mobiles.txt